...
export class ProjectControllerBase {
  ...
  @common.Get("/:id/projectRole")
  @ApiNestedQuery(UserFindManyArgs)
  async findManyProjectRole(
    @common.Req() request: Request,
    @common.Param() params: ProjectWhereUniqueInput
  ): Promise<User[]> {
    const query = plainToClass(UserFindManyArgs, request.query);
    const results = await this.service.findProjectRole(params.id, {
      ...query,
      select: {
        createdAt: true,
        firstName: true,
  ...
  @common.Post("/:id/projectRole")
  async connectProjectRole(
    @common.Param() params: ProjectWhereUniqueInput,
  ...
  @common.Delete("/:id/projectRole")
  async disconnectProjectRole(
    @common.Param() params: ProjectWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
